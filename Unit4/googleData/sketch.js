...
function gotData(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    bubbles.push(new Bubble(data[i].Name, data[i].Hobby, data[i]['Favorite Food'])); // THESE Name and Shape need to match your column names in your spreadsheet!
...
class Bubble {
  ...
  constructor(myName, myHobby, myFood) {
    this.name = myName;
    this.hobby = myHobby;
    this.food = myFood;
